        ...
        <div class="carousel-wrapper">
            <Carousel
             ...
             interval={6000}>
                ...
                <div className="headerr" style={{height:"65vh"}} >
                    <img src="../static/redesign/images/slides/slide10.jpg" style={{objectFit: "cover",opacity:"0.2",height:"100%",backgroundSize: 'cover', backgroundPosition: '50% 50%', backgroundRepeat: 'no-repeat'}}  />
                ...
                <div className="headerr" style={{height:"65vh"}} >
                    <img src="../static/redesign/images/slides/slide3.jpg" style={{objectFit: "cover",opacity:"0.2",height:"100%",backgroundSize: 'cover', backgroundPosition: '50% 50%', backgroundRepeat: 'no-repeat'}}  />
                ...
                <div className="headerr" style={{height:"65vh"}} >
                    <img src="../static/redesign/images/slides/slide5.jpg" style={{objectFit: "cover",opacity:"0.2",height:"100%",backgroundSize: 'cover', backgroundPosition: '50% 50%', backgroundRepeat: 'no-repeat'}}  />
                    <div style={{position: "absolute",width:"100%",color:"#fff",top: "50%",left:"50%",transform: "translate(-50%, -50%)"}}>
